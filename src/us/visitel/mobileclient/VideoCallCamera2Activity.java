...
import us.visitel.mobileclient.PeerConnectionClientCamera2.PeerConnectionParameters;
 ...
 */
public class VideoCallCamera2Activity extends Activity
        implements NclWebSocketChannelClient.WebSocketChannelEvents,
        PeerConnectionClientCamera2.PeerConnectionEvents,
        CallFragment.OnCallEvents,
        RendererCommon.RendererEvents {
    private static final String TAG = "VideoCallCamera2";
...
//    }
    ...
    private PeerConnectionClientCamera2 peerConnectionClient = null;
...
//                        | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY);
        ...
        setContentView(R.layout.activity_call_camera2);
        ...
        pipRenderer.init(rootEglBase.getEglBaseContext(), this);
        pipRenderer.setScalingType(ScalingType.SCALE_ASPECT_FIT);

        fullscreenRenderer.init(rootEglBase.getEglBaseContext(), null);
        fullscreenRenderer.setScalingType(ScalingType.SCALE_ASPECT_FIT);
...
//                cpuOveruseDetection);
        ...
        PeerConnectionClientCamera2.DataChannelParameters dataChannelParameters = null;
...
//            logAndToast(getString(R.string.connecting_to, contactName));
            ...
            peerConnectionClient = PeerConnectionClientCamera2.getInstance();
//            if (loopback) {
...
//            }
            peerConnectionClient.createPeerConnectionFactory(
                    getApplicationContext(), peerConnectionParameters, VideoCallCamera2Activity.this);
//
...
//            }
    ...
    private boolean captureToTexture() {
        return sharedPrefGetBoolean(R.string.pref_capturetotexture_key,
                EXTRA_CAPTURETOTEXTURE_ENABLED, R.string.pref_capturetotexture_default,
                false); 
...
//    // Create peer connection factory when EGL context is ready.
    ...
    protected void onDestroy() {
        ...
        Log.d(TAG, "VideoCallCamera2Activity destroyed");
        disconnect();
...
//                logAndToast("Stream added");
    ...
    public void onFrameResolutionChanged(int videoWidth, int videoHeight, int rotation) {
        final int rotationDegree = rotation;
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if ((rotationDegree % 180) == 90) {
                    ViewGroup.LayoutParams layoutParams = pipRenderer.getLayoutParams();
                    int width = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 96, getResources().getDisplayMetrics());
                    int height = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 128, getResources().getDisplayMetrics());
                    ...
                    ViewGroup.LayoutParams layoutParams = pipRenderer.getLayoutParams();
                    int width = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 128, getResources().getDisplayMetrics());
