...
public class PeerConnectionClient {
    ...
    public interface PeerConnectionEvents {
        ...
        void onIceFailed();
        /**
         * Callback fired once peer connection is Failed.
         */
    ...
    public PeerConnectionClient(Context appContext, EglBase eglBase,
        ...
        this.dataChannelEnabled = false;//peerConnectionParameters.dataChannelParameters != null
        Log.d(TAG, "Preferred video codec: " + VIDEO_CODEC_VP8);
    ...
    private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options options) {
        ...
        final AudioDeviceModule adm = createJavaAudioDevice();
                ...
                /*peerConnectionParameters.useLegacyAudioDevice
    ...
    private void createPeerConnectionInternal() {
        ...
        // ICE-TCP.
        rtcConfig.iceTransportsType = PeerConnection.IceTransportsType.ALL;//RELAY ALL
        rtcConfig.tcpCandidatePolicy = PeerConnection.TcpCandidatePolicy.ENABLED;
        rtcConfig.bundlePolicy = PeerConnection.BundlePolicy.MAXBUNDLE;//BALANCED MAXBUNDLE
        ...
        if (dataChannelEnabled) {
            Log.d(TAG,"dataChannel initialize");
    ...
    private class SDPObserver implements SdpObserver {
        ...
        public void onSetSuccess() {
            executor.execute(() -> {
                ...
                if (CallManager.getInstance()._isInitiator) {//isInitiator
