...
// val type: String?, val conversationid: String?, val dst: String?, val id: String?,
// val displayname: String?, val visitationid: String?, val status: String?,
// val param0: String?, val param1: String?, val param2: String?, val param3: String?
class ra_call_rcv(
        val type: String?, val conversationid: String?, val dst: String?, val id: String?,
        val displayname: String?, val visitationid: String?, val status: String?,
        val param0: String?, val param1: String?, val param2: String?, val param3: String?) : Parcelable {

    companion object {
        @JvmField
        val CREATOR = object : Parcelable.Creator<ra_call_rcv> {
            override fun createFromParcel(parcel: Parcel) = ra_call_rcv(parcel)
            override fun newArray(size: Int) = arrayOfNulls<ra_call_rcv>(size)
        }
    }
    ...
    private constructor(parcel: Parcel) : this(
            ...
            visitationid = parcel.readString(),
            status = parcel.readString(),
            param0 = parcel.readString(),
...
class Contact(val displayname: String?, val id: Long?) : Parcelable {
